...
const vikaFields = {
  ...
  data: {
    fields: [
      ...
      { id: 'fldN7PzpNtC2V', name: '值|value', type: 'Text', editable: true },
      { id: 'fldTmdV4rFU0v', name: '说明|desc', type: 'Text', editable: true },
    ],
  },
  message: 'SUCCESS',
};
...
const defaultRecords: any = {
  ...
  data: {
    ...
    records: [
      ...
      {
        recordId: 'recnp5ZezzfXn2',
        createdAt: 1694149441000,
        updatedAt: 1694149441000,
        fields: {
          '标识|key': 'MQTT_PORT_SSL',
          '配置项|name': 'MQTT连接-端口号SSL',
          '说明|desc': 'MQTT连接配置信息，推荐使用百度云的物联网核心套件',
          '值|value': '8084',
        },
      },
